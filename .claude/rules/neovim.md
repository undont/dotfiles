...
- `lua/custom/core/`: autocmds.lua, build.lua, diff-highlights.lua, folding.lua, keymaps.lua, lists.lua, macos-nav.lua, options.lua, refresh.lua, scan_runner.lua, spellcheck.lua, theme.lua, windows.lua
