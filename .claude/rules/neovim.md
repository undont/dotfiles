...
- `lua/custom/features/`: binary-view.lua, build.lua, claude-comments.lua, dap-breakpoints.lua, diag-scan.lua, diff-edit.lua, dotnet-test.lua, lists.lua, lsp-fix-all.lua, lsp-navigation.lua, lsp-patches.lua, neo-tree-git-patch.lua, octo-review-cache.lua, prompt-file-ref.lua, roslyn-diagnostics.lua, roslyn-semantic-tokens.lua, scan-runner.lua, sonar-actions.lua, sonar-common.lua, sonar-rule-popup.lua, sonar-rules.lua, sonar-scan.lua, statusline.lua, tag-rename.lua, ticket.lua, treesitter-parsers.lua
