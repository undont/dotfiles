// Starfield shader for Ghostty
// Source: https://github.com/0xhckr/ghostty-shaders
//
// Animated stars flying towards you, rendered behind terminal text.
// Adjust `threshold` to control how much terminal content shows through.

// transparent background
const bool transparent = false;

// terminal contents luminance threshold to be considered background (0.0 to 1.0)
// raise this if stars don't appear with your theme (most dark themes need ~0.2)
...
const float blueChance = 0.3; // Fraction of stars that are blue-tinted
...
vec3 stars(vec2 uv, float offset) {
    ...
    // Set stars to be white, with some blue-tinted
    float isBlue = step(1.0 - blueChance, N21(ipos + 1.));
    vec3 starColor = mix(white, vec3(0.4, 0.6, 1.0), isBlue);
