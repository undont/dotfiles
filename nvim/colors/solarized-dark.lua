...
hl('DiffText', { fg = colors.blue, bg = colors.line_highlight, bold = true })
...
hl('GitSignsAddLn', { bg = '#16413a' })
hl('GitSignsChangeLn', { bg = '#1b3f3a' })
hl('GitSignsDeleteLn', { bg = '#20353f' })
hl('GitSignsAddNr', { fg = colors.green, bg = '#16413a' })
hl('GitSignsChangeNr', { fg = colors.yellow, bg = '#1b3f3a' })
hl('GitSignsDeleteNr', { fg = colors.red, bg = '#20353f' })
