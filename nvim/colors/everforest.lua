...
-- syntax highlighting (role split per upstream sainnhe/everforest)
hl('Comment', { fg = colors.comment, italic = true })
hl('Constant', { fg = '#83c092' })
hl('String', { fg = '#a7c080' })
...
hl('Function', { fg = '#a7c080' })
hl('Statement', { fg = '#e67e80' })
hl('Conditional', { fg = '#e67e80' })
hl('Repeat', { fg = '#e67e80' })
hl('Label', { fg = '#e69875' })
hl('Operator', { fg = '#e69875' })
hl('Keyword', { fg = '#e67e80' })
hl('Exception', { fg = '#e67e80' })
hl('PreProc', { fg = '#d699b6' })
hl('Include', { fg = '#d699b6' })
hl('Define', { fg = '#d699b6' })
hl('Macro', { fg = '#83c092' })
hl('PreCondit', { fg = '#d699b6' })
hl('Type', { fg = '#dbbc7f' })
hl('StorageClass', { fg = '#e69875' })
hl('Structure', { fg = '#e69875' })
hl('Typedef', { fg = '#e67e80' })
hl('Special', { fg = '#dbbc7f' })
hl('SpecialChar', { fg = '#dbbc7f' })
hl('Tag', { fg = '#e69875' })
...
-- treesitter (role split per upstream sainnhe/everforest)
hl('@variable', { fg = colors.fg_variable })
hl('@variable.builtin', { fg = '#d699b6' })
hl('@variable.parameter', { fg = colors.fg_primary })
hl('@variable.member', { fg = '#7fbbb3' })
hl('@constant', { fg = colors.fg_primary })
hl('@constant.builtin', { fg = '#d699b6' })
hl('@module', { fg = '#dbbc7f' })
hl('@string', { fg = '#83c092' })
hl('@string.escape', { fg = '#a7c080' })
hl('@string.special', { fg = '#dbbc7f' })
hl('@character', { fg = '#83c092' })
hl('@number', { fg = '#d699b6' })
hl('@boolean', { fg = '#d699b6' })
hl('@function', { fg = '#a7c080' })
hl('@function.builtin', { fg = '#a7c080' })
hl('@function.call', { fg = '#a7c080' })
hl('@function.macro', { fg = '#a7c080' })
hl('@method', { fg = '#a7c080' })
hl('@method.call', { fg = '#a7c080' })
hl('@constructor', { fg = '#a7c080' })
hl('@keyword', { fg = '#e67e80' })
hl('@keyword.function', { fg = '#e67e80' })
hl('@keyword.operator', { fg = '#e69875' })
...
hl('@exception', { fg = '#e67e80' })
hl('@type', { fg = '#dbbc7f' })
hl('@type.builtin', { fg = '#dbbc7f' })
hl('@type.qualifier', { fg = '#e69875' })
hl('@property', { fg = '#7fbbb3' })
hl('@attribute', { fg = '#d699b6' })
hl('@tag', { fg = '#e69875' })
hl('@tag.attribute', { fg = '#a7c080' })
hl('@tag.delimiter', { fg = '#a7c080' })
hl('@punctuation.delimiter', { fg = colors.fg_secondary })
hl('@punctuation.bracket', { fg = colors.fg_primary })
hl('@punctuation.special', { fg = '#7fbbb3' })
