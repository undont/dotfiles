...
hl('GitSignsAddLn', { bg = '#394340' })
hl('GitSignsChangeLn', { bg = '#404340' })
hl('GitSignsDeleteLn', { bg = '#413c40' })
hl('GitSignsAddNr', { fg = colors.green, bg = '#394340' })
hl('GitSignsChangeNr', { fg = colors.yellow, bg = '#404340' })
hl('GitSignsDeleteNr', { fg = colors.red, bg = '#413c40' })
